...
public class CreacionComicTest {
	...
	private void llenarListaComics() {
		ComicDTO comic1 = new ComicDTO("1a", "Thor", "marvel", TematicaEnum.CIENCIA_FICCION, "1", 10, new BigDecimal(300000), "autor1", true, LocalDate.of(2021, 03, 10), EstadoEnum.ACTIVO,new Long(200));
		comics.add(comic1);
		ComicDTO comic2 = new ComicDTO("2a", "lol", "liga justicia", TematicaEnum.FANTASTICO, "2", 8, new BigDecimal(200000), "autor2", false, LocalDate.of(2021, 03, 20), EstadoEnum.INACTIVO,new Long(200));
		comics.add(comic2);
		ComicDTO comic3 = new ComicDTO("3a", "MM", "marvel", TematicaEnum.AVENTURAS, "1", 5, new BigDecimal(350000), "autor3", true, LocalDate.of(1998, 03, 20), EstadoEnum.ACTIVO,new Long(200));
		comics.add(comic3);
		ComicDTO comic4 = new ComicDTO("4a", "th", "loga justicia", TematicaEnum.HORROR, "2", 8, new BigDecimal(100000), "autor4", true, LocalDate.of(2010, 03, 10), EstadoEnum.ACTIVO,new Long(200));
		comics.add(comic4);
		ComicDTO comic5 = new ComicDTO("5a", "SM", "marvel", TematicaEnum.FANTASTICO, "3", 10, new BigDecimal(180000), "autor5", true, LocalDate.of(2000, 03, 20), EstadoEnum.INACTIVO,new Long(200));
		comics.add(comic5);
		ComicDTO comic6 = new ComicDTO("6a", "SH", "marvel", TematicaEnum.CIENCIA_FICCION, "7", 15, new BigDecimal(370000), "autor6", false, LocalDate.of(2018, 03, 10), EstadoEnum.ACTIVO,new Long(200));
		comics.add(comic6);
		ComicDTO comic7 = new ComicDTO("7a", "VG", "loga justicia", TematicaEnum.HISTORICO, "1", 19, new BigDecimal(120000), "autor7", true, LocalDate.of(2015, 03, 17), EstadoEnum.ACTIVO,new Long(200));
		comics.add(comic7);
		ComicDTO comic8 = new ComicDTO("8a", "LJ", "marvel", TematicaEnum.AVENTURAS, "1", 8, new BigDecimal(300000), "autor8", false, LocalDate.of(2003, 03, 20), EstadoEnum.INACTIVO,new Long(200));
		comics.add(comic8);
		ComicDTO comic9 = new ComicDTO("9a", "OL", "marvel", TematicaEnum.CIENCIA_FICCION, "7", 10, new BigDecimal(170000), "autor9", true, LocalDate.of(2004, 03, 25), EstadoEnum.ACTIVO,new Long(200));
		comics.add(comic9);
		ComicDTO comic10 = new ComicDTO("10a", "HJ", "liga justicia", TematicaEnum.BELICO, "10", 15, new BigDecimal(320000), "autor10", true, LocalDate.of(2021, 03, 18), EstadoEnum.INACTIVO,new Long(200));
		comics.add(comic10);
	}
